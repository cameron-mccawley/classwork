	...
	if ($_SERVER["REQUEST_METHOD"] == "POST") {
		if(isset($_SESSION["Ssn"]) && !empty($_SESSION["Ssn"])){ 
			...
			// Bind variables to the prepared statement as parameters
				mysqli_stmt_bind_param($stmt, "ss", $param_Ssn, $param_Dname);
				// Set parameters
                $param_Ssn = $Ssn;
                $param_Dname = $Dname;
                ...
                <div class="col-md-12">
                    ...
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="alert alert-danger fade in">
                            ...
                            <p>Are you sure you want to delete the record for <?php echo ($_SESSION["Ssn"]); ?> dependent name <?php echo ($_SESSION["Dname"]); ?>?</p><br>
